...
export const ROUTES: RouteInfo[] = [
  ...
  {
    path: "/immobilier-app/notification",
    title: "notificcation",
  ...
  {
    path: "/immobilier-app/proprietaire",
    title: "Proprietaires",
    icon: "icon-people",
    class: "",
    label: "",
  ...
  {
    path: "/immobilier-app/parcelle-appartement",
    title: "Habitations",
    icon: " fas fa-university",
    class: "",
    label: "",
